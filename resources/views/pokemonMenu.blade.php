...
<body>
    <div id="gameboy" class="gameboy">
        ...
        <div id="buttonsMenu" class="buttonsMenu">
            <div id="buttonStart" class="buttonStart"><p>Start</p><div class="whiteButton btn"></div></div>
            <div id="buttonSelect" class="buttonSelect"><p>Select</p><div class="whiteButton btn"></div></div>
        </div>
        ...
        <div id="powerButton" class="powerButton"><p>Power</p></div>
        <div id="buttonsAction" class="buttonsAction">
            <div id="buttonA" class="buttonA btn">A</div>
            <div id="buttonB" class="buttonB btn">B</div>
        </div>
